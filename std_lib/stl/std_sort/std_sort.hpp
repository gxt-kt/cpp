...
inline void InsertionSort(int arr[], int *begin, int *end) {
...
inline void IntrosortUtil(int arr[], int *begin, int *end, int depthLimit) {
...
inline void Introsort(int arr[], int *begin, int *end) {
